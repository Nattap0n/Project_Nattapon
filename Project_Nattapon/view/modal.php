        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-3 px-md-5 py-3 py-md-3">
                ...
                <form action="php/action.php" method="post">
                    ...
                    <!-- <div class="form-floating mb-3">
                        <input type="text" class="form-control shadow" id="inputdistance" name="inputdistance" placeholder="กรอกชื่อผู้ใช้">
                        <label for="inputdistance"> ระยะทาง </label>
                    </div> -->
                    <input type="hidden" name="userid" value="userid">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control shadow" id="userid" name="userid" value="<?= $user['id'] ?>">
            ...
            <div class="d-flex justify-content-center">
                ...
                <button type="submit" class="btn btn-primary mx-3">ยืนยัน</button>
            </div>
            </form>
        </div>
    </div>
